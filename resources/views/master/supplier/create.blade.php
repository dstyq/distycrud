...
<div class="content">
    <form action="{{ route('master.supplier.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('nomor_handphone') is-invalid @enderror" name="nomor_handphone" id="nomor_handphone" value="{{ old('nomor_handphone') }}" required>
        ...
        <a href="{{ route('master.supplier.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
</div>
@endsection
